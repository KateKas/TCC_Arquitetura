import { AgrupamentoFormComponent } from './agrupamento-form/agrupamento-form.component';
...
import { ConfirmInsercaoSkuDialogComponent } from '../skus/confirm-insercao-sku-dialog/confirm-insercao-sku-dialog.component';
import { EditRespostasSkuDialogComponent } from '../skus/edit-respostas-sku-dialog/edit-respostas-sku-dialog.component';

const routes = [
    {
        path: 'cadastro/agrupamento',
        component: AgrupamentoComponent
    }
];

@NgModule({
    declarations: [AgrupamentoComponent, AgrupamentoFormComponent, AgrupamentoCorrelatosDialogComponent, DeleteAgrupamentosCorrelatosDialogComponent, DeleteAgrupamentoComponent],
    exports: [
        A11yModule,
        CdkStepperModule,
        CdkTableModule,
